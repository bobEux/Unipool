...
const Balpool = artifacts.require('BalpoolMock');
...
contract('Balpool', function ([_, wallet1, wallet2, wallet3, wallet4]) {
    describe('Balpool', async function () {
        beforeEach(async function () {
            this.uni = await Uni.new();
            this.snx = await Snx.new();
            this.pool = await Balpool.new(this.uni.address, this.snx.address);
